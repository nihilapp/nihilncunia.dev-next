...
/**
 * 쿠키 헤더 문자열을 파싱하는 헬퍼 함수
 */
function parseCookieHeader(cookieHeader: string): Array<{ name: string; value: string | null }> {
...
/**
 * 쿠키를 Set-Cookie 헤더 문자열로 직렬화하는 헬퍼 함수
 */
function serializeCookieHeader(name: string, value: string, options: CookieOptions): string {
